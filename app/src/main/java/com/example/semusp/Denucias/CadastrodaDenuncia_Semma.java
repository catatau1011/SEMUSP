...
import com.example.semusp.Telas.ListaSemma;
import com.example.semusp.R;

public class CadastrodaDenuncia_Semma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastroda_denuncia);
        getSupportActionBar().hide();

        textView = findViewById(R.id.txtesultado);
        ...
        //////////////////////////////////////////////////q
        Resgistrar = findViewById(R.id.btnRegistrarSemma);
        ...
        Resgistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String textoAutor = Autor.getText().toString();
                String textoData = Data.getText().toString();

                if (!textoDescricao.isEmpty() && !textoAutor.isEmpty() && !textoData.isEmpty()){
                    Intent intent = new Intent(CadastrodaDenuncia_Semma.this, ListaDefesaCivil.class);
                    intent.putExtra("Chave",textoDescricao);
                    intent.putExtra("Chave1",textoAutor);
                    intent.putExtra("Chave2",textoData);
                    startActivity(intent);
                    finish();
                }else {
                    Toast.makeText(CadastrodaDenuncia_Semma.this,"Preencha Todos os Campos!Por favor",Toast.LENGTH_SHORT).show();
                }
